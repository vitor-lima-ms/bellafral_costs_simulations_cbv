...
class Custo(models.Model):
    ...
    custoTnt162 = models.DecimalField(verbose_name='TNT 162 (R$)', max_digits=10, decimal_places=4, default=0)
    ...
    custoPolietileno162 = models.DecimalField(verbose_name='Polietileno 162 (R$)', max_digits=10, decimal_places=4, default=0)
